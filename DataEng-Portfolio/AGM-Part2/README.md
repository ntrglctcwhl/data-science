...
- Part 2.1: create and load the product mapping table

- Part 2.2: parsing Peak's sales JSON files into CSV files

- Part 2.3: create and load staging tables

- Part 2.4: validate data in the staging tables using SQL

- Part 2.5: run SQL queries to explore cleansing of the customer data

- Part 2.6: perform some preliminary analytics on data in the staging tables to answer specific questions from executives

- Part 2.7: write an analysis on continuing to withhold customer data from 3rd party sales channels
